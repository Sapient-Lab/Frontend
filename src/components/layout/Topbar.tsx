...
export default function Topbar() {
  const currentPath = '/lab' // luego esto vendrá del router
  ...
  return (
    <header className="h-[52px] bg-surface border-b border-lab-border flex items-center px-6 gap-8 sticky top-0 z-50">
      ...
      {/* Brand */}
      <div className="flex items-center gap-2.5 font-semibold text-[15px] text-accent tracking-tight">
