            ...
            <div className="z-10">
              <div className="flex justify-between items-start mb-6">
                <div>
                  ...
                  <h2 className="text-xl font-semibold text-gray-800 mb-1">Interpretación de protocolos y control de riesgo</h2>
                  <p className="text-sm text-gray-500">Bloque 3 de 7 • Evidencia estructurada y checklist de bioseguridad</p>
                </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-6 h-full">
            ...
            >
              ...
              <p className="text-xs text-gray-500 mb-4">Interpreta protocolos, genera checklist trazable y destaca límites de seguridad en contextos biológicos o clínicos.</p>
